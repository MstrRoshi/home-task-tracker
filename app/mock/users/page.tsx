...
import { users as initialUsers, isUserInList } from "../../../src/lib/data";
import { MockNavbar } from "../../../src/components/MockNavbar";
...
export default function MockUsersPage() {
  ...
  useEffect(() => {
    if (session?.user) {
      ...
      if (!isUserInList(authUser.id, users)) {
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main className="flex-1 p-4 flex items-center justify-center">
          <div className="text-center">
            ...
            <Button onClick={() => window.location.href = "/mock"}>
              Sign In
            </Button>
          </div>
        </main>
        ...
        <div className="w-full max-w-3xl mx-auto">
          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-6">
            ...
            <p className="text-yellow-700 text-sm mt-1">
              You're using the mock authentication system. This is a fallback solution while the NextAuth.js integration is being fixed.
            </p>
          </div>
